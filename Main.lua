...
function promptRet.create(title, description, primary, secondary, callback)
    ...
    -- Customize colors
    prompt.Policy.BackgroundColor3 = Color3.fromRGB(36, 22, 22) -- background
    prompt.Policy.Title.TextColor3 = Color3.fromRGB(0, 0, 0) -- Black text
    prompt.Policy.Notice.TextColor3 = Color3.fromRGB(0, 0, 0) -- Light gray text

    -- Primary button (Accept) set to blue (RGB 0, 0, 200)
    prompt.Policy.Actions.Primary.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- Black button
    prompt.Policy.Actions.Primary.Title.TextColor3 = Color3.fromRGB(255, 255, 255) -- White text for Primary button

    -- Secondary button remains unchanged (default color, you can customize it if needed)
    prompt.Policy.Actions.Secondary.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- Default black or any color you prefer for the secondary button
    prompt.Policy.Actions.Secondary.Title.TextColor3 = Color3.fromRGB(0, 0, 0) -- White text for Secondary button
    ...
    prompt.Policy.Actions.Secondary.Interact.MouseEnter:Connect(function()
        if debounce then return end
        tweenService:Create(prompt.Policy.Actions.Secondary.Title, TweenInfo.new(0.4, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {TextTransparency = 0}):Play()
    end)

    prompt.Policy.Actions.Secondary.Interact.MouseLeave:Connect(function()
        if debounce then return end
        tweenService:Create(prompt.Policy.Actions.Secondary.Title, TweenInfo.new(0.4, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {TextTransparency = 0.4}):Play()
    end)
